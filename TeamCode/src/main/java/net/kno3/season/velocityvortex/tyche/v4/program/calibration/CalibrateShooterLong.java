 ...
 */
@TeleOp(group = "calibration", name = "Calibrate Shooter (long)")
public class CalibrateShooterLong extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        adjuster.addValue("speed", "Speed", 0, 1);
        adjuster.addValue("waitCount", "Feeding Delay", 1, 10000);

        while(opModeIsActive()) {
            speed = settings.getShooterLongBase();
            waitCount = settings.getShooterFeedDelay() / 1000D;
            ...
            settings.setShooterLongBase(speed);
