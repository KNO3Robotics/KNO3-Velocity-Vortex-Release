...
public abstract class KNO3LinearOpMode extends OpMode {
    ...
    final public void init() {
        ...
        this.helper          = new KNO3LinearOpMode.LinearOpModeHelper();
    ...
    protected class LinearOpModeHelper implements Runnable {
        ...
        public void run() {
            ThreadPool.logThreadLifeCycle("LinearOpMode main", new Runnable() { @Override public void run() {
                ...
                try {
                    KNO3LinearOpMode.this.runOpMode();
                    requestOpModeStop();
